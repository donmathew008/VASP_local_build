...
#### We have included the "makefile.include.gnu_ompi" in this repository, download and rename it as "makefile.include" and give necessary changes and just go to make
    cd ..
    make DEPS=1 -j
